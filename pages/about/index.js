      ...
      <div className="h-full bg-primary/30 py-24 xl:py-40 text-center xl:text-left" ref={contentRef} style={{ overflowY: 'auto' }}>
        ...
        <div className="container mx-auto h-full flex flex-col items-center mr-20 xl:flex-row gap-x-6">
          ...
          <motion.div
            ...
            animate="show"
            exit="hidden"
            className="flex flex-col w-full xl:max-w-[48%] h-auto xl:h-[480px] xl:py-32"
          >
            <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4">
              {aboutData.map((item, itemIndex) => (
                <div
                  key={item.title}
                  className={`${index === itemIndex ? "text-accent after:w-[100px] after:bg-accent after:transition-all after:duration-300" : ""} cursor-pointer capitalize xl:text-lg relative after:w-8 after:h-[2px] after:bg-white after:absolute after:-bottom-1 after:left-0`}
