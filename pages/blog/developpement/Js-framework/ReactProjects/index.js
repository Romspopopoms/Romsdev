...
const projects = [
  {
    ...
    description: 'Créez votre propre site portfolio en utilisant React.',
    link: '/blog/developpement/Js-framework/ReactProjects/portfolio',
  ...
  },
  {
    ...
    link: '/blog/developpement/Js-framework/ReactProjects/todo-list',
  ...
  
  {
    ...
    link: '/blog/developpement/Js-framework/ReactProjects/calendar',
  ...
  },
  {
    ...
    link: '/blog/developpement/Js-framework/ReactProjects/notes-app',
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto text-white bg-gray-900 hide-scrollbar">
      <Head>
        ...
        <meta name="description" content="Suivez nos guides pas à pas pour réaliser des projets simples avec React." />
        <meta name="keywords" content="React, projets, tutoriels, développement web" />
        <link rel="canonical" href="https://romsdev.fr/blog/developpement/Js-framework/ReactProjects" />
      </Head>
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col items-center mt-16">
        ...
        <p className="text-center font-bold text-xl lg:text-2xl mb-12">Suivez nos guides détaillés pour réaliser des projets simples avec React.</p>
          ...
          {projects.map((project, index) => (
            <div key={index} className="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-center">
              ...
              <Link href={project.link}
                 className="text-blue-500 hover:underline">Commencer
              </Link>
            </div>
          ))}
        </div>
