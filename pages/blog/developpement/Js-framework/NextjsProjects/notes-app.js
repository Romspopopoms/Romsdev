...
li {
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto text-white  hide-scrollbar">
      <Head>
        <title>Créer une Application de Notes avec Next.js | RomsDev</title>
        <meta name="description" content="Suivez ce guide pas à pas pour créer votre propre application de Notes en utilisant Next.js." />
        <meta name="keywords" content="Next.js, notes, tutoriel, développement web" />
        <link rel="canonical" href="https://romsdev.fr/blog/developpement/Js-framework/NextjsProjects/notes-app" />
      </Head>

      <NavBlog />

      <div className="container mx-auto px-4 py-8 flex flex-col items-center mt-16">
        <h1 className="text-4xl lg:text-6xl font-bold text-center mb-12">Créer une Application de Notes avec Next.js<span className="text-accent">.</span></h1>
        ...
        <section id="introduction" className="mb-24 w-full md:w-3/4 lg:w-2/3">
          ...
          <p className="text-lg lg:text-xl text-center mb-8">
            Dans ce tutoriel, nous allons créer une application de Notes en utilisant Next.js. Ce guide détaillé vous accompagnera étape par étape pour configurer votre projet, structurer vos dossiers, créer vos composants, ajouter du style et déployer votre application de Notes en ligne.
          </p>
        </section>
        ...
        <section id="setup" className="mb-24 w-full md:w-3/4 lg:w-2/3">
          ...
          <p className="text-lg lg:text-xl text-center mb-8">
            Commençons par la configuration de notre projet. Suivez ces étapes pour installer Node.js, créer une application Next.js, et préparer votre environnement de développement.
          </p>
...
`}
        ...
        <section id="components" className="mb-24 w-full md:w-3/4 lg:w-2/3">
          ...
          <p className="text-lg lg:text-xl text-center mb-8">
            Nous allons maintenant créer les composants de base de notre application de Notes, y compris le Header, Notes et App.
          </p>
          <h3 className="text-2xl font-semibold mb-4">Composant Notes</h3>
          <div className="bg-gray-600 p-4 rounded-lg mb-4 mt-4">
            <pre
              className="bg-gray-500 p-4 rounded overflow-x-auto"
              style={{ whiteSpace: 'pre-wrap' }}
        ...
        <section id="styling" className="mb-24 w-full md:w-3/4 lg:w-2/3">
          ...
          <p className="text-lg mb-4">
            Ajoutez les styles suivants à votre fichier <code>styles/globals.css</code> pour styliser votre application de Notes :
          </p>
          <div className="bg-gray-600 p-4 rounded-lg mb-4 mt-4">
            <pre
              className="bg-gray-500 p-4 rounded overflow-x-auto"
        ...
        >
          <div>
            ...
            <ul className="list-disc pl-5">
              <li><Link href="/blog/developpement/Js-framework/NextjsProjects/calendar" className="text-blue-500 hover:underline">Projet Précédent : Application Calendrier avec Next.js</Link></li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 lg:mx-8">
              <li><Link href="/blog/developpement/Js-framework/ReactTuto/Gestion-des-Etats" className="text-blue-500 hover:underline">Gestion des États</Link></li>
              ...
              <li><Link href="/blog/developpement/Js-framework/NextjsTuto/Pages-Routing" className="text-blue-500 hover:underline">Routing en Next.js</Link></li>
            </ul>
          </div>
        </section>
