...
import { FaLaptopCode, FaTasks, FaCalendarAlt, FaBook } from 'react-icons/fa';
import NavBlog from '../../../../../components/NavBlog';

const projects = [
  {
    title: 'Projet 1: Site Portfolio',
    description: 'Créez votre propre site portfolio en utilisant Next.js.',
    link: '/blog/developpement/Js-framework/NextjsProjects/portfolio',
    icon: <FaLaptopCode size={30} className="text-accent" />,
  },
  {
    title: 'Projet 2: Todo List',
    description: 'Développez une application de gestion de tâches avec Next.js.',
    link: '/blog/developpement/Js-framework/NextjsProjects/todo-list',
  ...
  },
  {
    ...
    link: '/blog/developpement/Js-framework/NextjsProjects/calendar',
  ...
  },
  {
    ...
    link: '/blog/developpement/Js-framework/NextjsProjects/notes-app',
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto text-white  hide-scrollbar">
      <Head>
        ...
        <meta name="keywords" content="Next.js, projets, tutoriels, développement web" />
        <link rel="canonical" href="https://romsdev.fr/blog/developpement/Js-framework/NextjsProjects" />
      </Head>
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col items-center mt-16">
        ...
        <p className="text-center font-bold text-xl lg:text-2xl mb-12">Suivez nos guides détaillés pour réaliser des projets simples avec Next.js.</p>
