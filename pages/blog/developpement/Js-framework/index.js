...
const JsFramework = () => {
  return (
    <div className="min-h-screen h-screen overflow-y-auto hide-scrollbar bg-gray-900" style={{ overflowY: 'auto' }}>
      <Head>
      ...
      <NavBlog />
      <div className="flex flex-col items-center justify-center sm:mt-20 mt-28 lg:mt-20 xl:mt-24 h-full w-full xxl:mt-32">
