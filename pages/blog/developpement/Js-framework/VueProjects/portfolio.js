...
.projects {
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto text-white bg-gray-900 hide-scrollbar">
      <Head>
        <title>Créer un Portfolio avec Vue.js | RomsDev</title>
        <meta name="description" content="Suivez ce guide pas à pas pour créer votre propre site portfolio en utilisant Vue.js." />
        <meta name="keywords" content="Vue.js, portfolio, tutoriel, développement web" />
        <link rel="canonical" href="https://romsdev.fr/blog/developpement/Js-framework/VueProjects/portfolio" />
      </Head>

      <NavBlog />

      <div className="container mx-auto px-4 py-8 flex flex-col items-center mt-16">
        <h1 className="text-4xl lg:text-6xl font-bold text-center mb-12">Créer un Portfolio avec Vue.js<span className="text-accent">.</span></h1>
        ...
        <section id="introduction" className="mb-24 w-full md:w-3/4 lg:w-2/3">
          ...
          <p className="text-lg lg:text-xl text-center mb-8">
            Dans ce tutoriel, nous allons créer un site portfolio en utilisant Vue.js. Ce guide détaillé vous accompagnera étape par étape pour configurer votre projet, structurer vos dossiers, créer vos composants, ajouter du style et déployer votre portfolio en ligne.
          </p>
        </section>
        ...
        >
          <div>
            ...
            <ul className="list-disc pl-5">
              <li><Link href="/blog/developpement/Js-framework/VueProjects/todo-list" className="text-blue-500 hover:underline">Prochain Projet : Todo List</Link></li>
...
export default PortfolioGuideVue;
