...
const projects = [
  {
    ...
    description: 'Créez votre propre site portfolio en utilisant Vue.js.',
    link: '/blog/developpement/Js-framework/VueProjects/portfolio',
    icon: <FaLaptopCode size={30} className="text-accent" />,
  },
  {
    title: 'Projet 2: Todo List',
    description: 'Développez une application de gestion de tâches avec Vue.js.',
    link: '/blog/developpement/Js-framework/VueProjects/todo-list',
  ...
  },
  {
    ...
    link: '/blog/developpement/Js-framework/VueProjects/calendar',
  ...
  },
  {
    ...
    link: '/blog/developpement/Js-framework/VueProjects/notes-app',
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto text-white bg-gray-900 hide-scrollbar">
      <Head>
        ...
        <meta name="description" content="Suivez nos guides pas à pas pour réaliser des projets simples avec Vue.js." />
        <meta name="keywords" content="Vue.js, projets, tutoriels, développement web" />
        <link rel="canonical" href="https://romsdev.fr/blog/developpement/Js-framework/VueProjects" />
      </Head>
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col items-center mt-16">
        ...
        <p className="text-center font-bold text-xl lg:text-2xl mb-12">Suivez nos guides détaillés pour réaliser des projets simples avec Vue.js.</p>
