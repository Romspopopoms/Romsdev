        ...
        <div className="w-full h-full flex flex-col items-center">
            ...
            >
                ...
                >
                    ...
                    A C C E S S I B I L I T E<span className="text-accent">.</span>
                    </motion.h2>
                    ...
                    <div className="relative w-full h-12">
                        ...
                        >
                            <FaUniversalAccess className="size-8 text-green-600" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaWheelchair className="size-8 text-blue-400" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaBlind className="size-8 text-red-600" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaAssistiveListeningSystems className="size-8 text-black" />
                        </motion.div>
                    </div>
                </motion.div>
            </motion.div>
                ...
                <motion.div className="z-10 flex flex-col gap-2">
                    ...
                    <div className="relative w-full h-12">
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaUniversalAccess className="size-10 text-green-600" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaWheelchair className="size-10 text-blue-400" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaBlind className="size-10 text-red-600" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaAssistiveListeningSystems className="size-10 text-black" />
                        </motion.div>
                    </div>
                </motion.div>
            </motion.div>
