...
import { FaUniversalAccess, FaWheelchair, FaBlind, FaAssistiveListeningSystems } from "react-icons/fa";
            ...
            >
                ...
                >
                    <motion.h2 className="text-xl relative text-white">
                        A C C E S S I B I L I T É<span className="text-accent"> .</span>
                    </motion.h2>
                    ...
                    <div className="relative w-full h-12">
                        ...
                        >
                            <FaUniversalAccess className="size-8 text-blue-500" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaWheelchair className="size-8 text-green-500" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaBlind className="size-8 text-yellow-500" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaAssistiveListeningSystems className="size-8 text-red-500" />
                        </motion.div>
                    </div>
                </motion.div>
            </motion.div>
                ...
                <motion.div className="z-10 flex flex-col gap-2">
                    ...
                    <div className="relative w-full h-12">
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaUniversalAccess className="size-10 text-blue-500" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaWheelchair className="size-10 text-green-500" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaBlind className="size-10 text-yellow-500" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaAssistiveListeningSystems className="size-10 text-red-500" />
                        </motion.div>
                    </div>
                </motion.div>
            </motion.div>
