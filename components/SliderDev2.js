            ...
            >
                ...
                >
                    ...
                    <div className="relative w-full h-12">
                        ...
                        >
                            <FaBolt className="size-8 text-green-600" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaRocket className="size-8 text-blue-400" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaStopwatch className="size-8 text-red-600" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaTachometerAlt className="size-8 text-black" />
                        </motion.div>
                    </div>
                </motion.div>
            </motion.div>
                ...
                <motion.div className="z-10 flex flex-col gap-2">
                    ...
                    <div className="relative w-full h-12">
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaBolt className="size-10 text-green-600" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaRocket className="size-10 text-blue-400" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaStopwatch className="size-10 text-red-600" />
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <FaTachometerAlt className="size-10 text-black" />
                        </motion.div>
                    </div>
                </motion.div>
            </motion.div>
